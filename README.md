...
Cyclistic’s historical trip data will be used to for data analysis, Click here to access the public dataset –> [link](https://divvy-tripdata.s3.amazonaws.com/index.html)
